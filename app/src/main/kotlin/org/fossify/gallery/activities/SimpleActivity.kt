...
open class SimpleActivity : BaseSimpleActivity() {
    ...
    private var spoofPackageNameForCommonsCheck = false
    ...
    override fun getPackageName(): String {
        return if (spoofPackageNameForCommonsCheck) "org.fossify.gallery" else super.getPackageName()
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        spoofPackageNameForCommonsCheck = true
        super.onCreate(savedInstanceState)
        spoofPackageNameForCommonsCheck = false
    }
